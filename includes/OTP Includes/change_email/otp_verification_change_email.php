...
<head>
    <title>OTP Verification - Change Email</title>
</head>
<body>

<div class="otp-verification-modal">
    <div class="otp-verification-modal-content">
        <h2>OTP Verification for Email Change</h2>
        <p>
            We’ve sent a 6-digit code to your current email to verify your email change request:
        ...
        <form action="<?= BASE_URL ?>/processes/OTP Processes/change_email/verify_otp_change_email.php" method="POST" autocomplete="off">
            <div class="form-group">
                <input type="text" id="otpCode" class="form-control" name="otpCode" placeholder=" " required maxlength="6" 
                    pattern="[0-9]{6}" inputmode="numeric" title="Please enter a 6-digit number" 
